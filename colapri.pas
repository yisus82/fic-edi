...
Procedure Cola_prioridad_vacia(VAR ColaPri:tCola_pri);
Function Es_cola_pri_vacia(ColaPri:tCola_pri):Boolean;
Function Insertar_cp(VAR ColaPri:tCola;Datos_cp:tDato):Boolean;
Function Primero_cp(Cola:tCola_pri):tPos_cp;
Function Ultimo_cp(Cola:tCola_pri):tPos_cp;
Function Existe_Pos_cp(Posicion:tPos_cp;ColaPri:tCola_pri):Boolean;
Function Borrar_cp(VAR ColaPri:tCola_pri; VAR d:tDato):Boolean;
Function Siguiente_cp(Posicion:tPos_cp;ColaPri:tCola_pri):tPos_cp;
Function Datos_Pos_cp(Posicion:tPos_cp;ColaPri:tCola_pri):tDato;


IMPLEMENTATION

PROCEDURE Cola_prioridad_vacia(VAR ColaPri:tCola_pri);
{Objetivo: Crear una Cola de prioridad vacia
 Entradas: Una Cola de prioridad de tipo Cola_pri
 Salidas: Una Cola de prioridad vacia de tipo Cola_pri}
BEGIN
 Cola:=nil;
END;
